...
<p align = "justify">Окно справки будет представлять собой текстовое поле с прокруткой, в котором будут содержаться правила игры и инструкция по подключению.</p>
