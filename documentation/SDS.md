...
<p align = "justify">Окно настроек будет содержать те пункты, которые окажутся необходимы в процессе разработки. Если таких пунктов не будет, то пункт настроек можно убрать из главного меню.</p>
